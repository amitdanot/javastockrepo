...
public class PortfolioManager implements PortfolioManagerInterface {
	...
	public void addStock(String symbol) {
		...
		try {
			...
			datastoreService.saveStock(toDto(portfolio.findStockPlace(symbol)));
	...
	private Stock fromDto(StockDto stockDto) {
		...
		if(stockDto.getRecommendation() != null) newStock.setRecommendation(com.mta.javacourse.model.Portfolio.ALGO_RECOMMENDATION.valueOf(stockDto.getRecommendation()));
